...
/**
 * KsefSessionOpenBatchRequest Class Doc Comment
 *
 * @category Class
 * @package  KsefApi
 * @author   OpenAPI Generator team
 ...
 */
class KsefSessionOpenBatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'KsefSessionOpenBatchRequest';
    ...
    protected static $openAPITypes = [
        ...
        'offline' => 'bool',
        'batch_info' => '\KsefApi\Model\BatchInfo'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('batch_info', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['batch_info'] === null) {
            $invalidProperties[] = "'batch_info' can't be null";
        }
     ...
     * Gets batch_info
     *
     * @return \KsefApi\Model\BatchInfo
     */
    public function getBatchInfo()
    {
        return $this->container['batch_info'];
    }

    /**
     * Sets batch_info
     *
     * @param \KsefApi\Model\BatchInfo $batch_info batch_info
     *
     * @return self
     */
    public function setBatchInfo($batch_info)
    {
        if (is_null($batch_info)) {
            throw new \InvalidArgumentException('non-nullable batch_info cannot be null');
        }
        $this->container['batch_info'] = $batch_info;
