...
class KsefInvoiceVisualizeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('include_logo', $data ?? [], null);
        $this->setIfExists('include_qr_code', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($include_logo)) {
            throw new \InvalidArgumentException('non-nullable include_logo cannot be null');
        }
    ...
    {
        if (is_null($include_qr_code)) {
            throw new \InvalidArgumentException('non-nullable include_qr_code cannot be null');
        }
